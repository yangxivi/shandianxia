...
面向企业 **10 台生产设备独立电表** 的日常抄表、自动核算与月度汇总系统。替代人工台账，实现
...
| 月度汇总 | 按自然月汇总单台设备 + 全厂 10 台整体总电量、总电费 |
...
│   │   ├── db.py            # 引擎/会话
│   │   └── seed.py          # 初始化 1 管理员 + 10 设备 + 10 抄表员 + 默认电价
...
1. 管理员登录后台 → **设备与倍率**：确认 10 台设备、倍率、绑定抄表责任人（一人一码）。
